...
const notificationHandler = require(APP_HANDLER_PATH + 'notification');
class NotificationController extends BaseController {
    ...
    getAll(req, res, next) {
        this._NotificationHandler.getAllnotfication(req, this._responseManager.getDefaultResponseHandler(res));
    ...
    getSingle(req, res, next) {
        ...
        this._NotificationHandler.getNotficationByCooperId(req, responseManager.getDefaultResponseHandlerError(res, ((data, message, code) => {
    ...
    create(req, res, next) {
        ...
        this._NotificationHandler.createNotification(req, this._responseManager.getDefaultResponseHandler(res));

        // this.authenticate(req, res, next, (token, user) => {
        //     this._verifyauthHandler.createNewPost(req, this._responseManager.getDefaultResponseHandler(res));
        // });
    }
    getNotficationByCooperId(req, res, next) {

        this._NotificationHandler.getNotficationByCooperId(req, this._responseManager.getDefaultResponseHandler(res));
