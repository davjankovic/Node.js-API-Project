...
class CategoryController extends BaseController {
    ...
    getAll(req, res, next) {
        this._CategoryHandler.getAllCategory(req, this._responseManager.getDefaultResponseHandler(res));
    ...
    create(req, res, next) {
        ...
        this._CategoryHandler.createCategory(req, this._responseManager.getDefaultResponseHandler(res));
