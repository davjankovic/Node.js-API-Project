...
class CooperativeHandler extends BaseAutoBindedClass {
    constructor() {
        super();
    ...
    createCooperative(req, callback) {
        let data = req.body;
        let validator = this._validator;
        req.checkBody(CooperativeHandler.VERIFY_COOPERATIVE_SCHEMA);
    ...
    deletecooperative(req, callback) {
        let data = req.body;
        ...
        req.getValidationResult()
            .then(function (result) {
                ...
                return new Promise(function (resolve, reject) {
                    CooperativeModel.findOne({ _id: req.params.id }, function (err, cooperative) {
                        if (err !== null) {
                            reject(err);
                        } else {
                            if (!cooperative) {
    ...
    updatecooperative(req, callback) {
        let data = req.body;
        let validator = this._validator;
        req.checkBody(CooperativeHandler.VERIFY_COOPERATIVE_SCHEMA);
        req.getValidationResult()
    ...
    getAllcooperative(req, callback) {
        let data = req.body;
        new Promise(function (resolve, reject) {
            CooperativeModel.find({}, function (err, cooperative) {
                if (err !== null) {
                    reject(err);
                } else {
                    resolve(cooperative);
...
module.exports = CooperativeHandler;